export const profile = {
  name: "Nyuydine Bill Leynyuy",
  role: "Senior Software Engineer · Software Architect",
  headline: "Software Engineer building AI-powered products.",
  tagline:
    "Full-stack development and software architecture, from backend to cloud infrastructure, shipped end to end.",
  ...
  expertise: [
    {
      ...
      description:
        "System design, service boundaries, and distributed systems architecture built to extend rather than be rewritten.",
    },
    {
      title: "AI Systems Engineering",
      description:
        "LLM integration, prompt engineering, and multi-step AI workflow orchestration in production, with human-review guardrails for high-stakes decisions.",
    },
    {
      title: "Cloud Infrastructure",
      description:
        "Deployments across Azure and AWS with Docker, Kubernetes, and GitHub Actions CI/CD. Observability is treated as part of the deployment, not an afterthought.",
    },
  ],
  stats: [
